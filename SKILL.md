...
## 2. Logique d'Aiguillage (Analyse Initiale)
Avant toute rédaction, examine le texte brut et choisis la posture la plus adaptée :
...
## 3. Directives de Style et Formats
...
* N'affiche aucun commentaire d'introduction ni de conclusion. Produis directement la structure de sortie applicable (Posture A ou Posture B).

## 4. Modèles de Structures de Sortie

[MODÈLE POUR POSTURE A - MÉMOIRE & ARCHIVAGE]
### 📝 RELEVÉ DE DÉCISIONS ET COMPTE RENDU
* **Objet :** [Titre factuel et clair du point de réunion]
* **Statut :** Pour Archivage / Suivi

#### 🔍 1. SYNTHÈSE DES ÉCHANGES
[Résumé structuré, dense et chronologique des grands sujets abordés]

#### 📊 2. DONNÉES CLÉS & ÉLÉMENTS FINANCIERS
[Tableau Markdown si chiffres, dates ou budgets évoqués. Sinon, liste à puces synthétique]

#### 🎯 3. ACTIONS ENGAGÉES & PROCHAINES ÉTAPES
* [ ] **Action 1 :** [Qui fait quoi / Échéance]

[MODÈLE POUR POSTURE B - ORIENTATION & ARBITRAGE]
### ⚠️ NOTE D'ORIENTATION ET D'ARBITRAGE
* **Objet :** [Titre problématisé résumant la tension ou l'enjeu stratégique]
* **Statut :** Alerte / Arbitrage Requis

#### 👁️ SYNTHÈSE EXÉCUTIVE (Le Brief)
* **L'Enjeu :** [Synthèse dense de la problématique]
* **Le Point de Verrou :** [Ce qui bloque]
* **L'Arbitrage Attendu :** [La décision précise à prendre]

#### 🏛️ 1. CONTEXTE & DYNAMIQUE DE GOUVERNANCE
[Analyse des rapports de force et de l'alignement des acteurs Ville de Toulouse / Toulouse Métropole]

#### 📉 2. TRAJECTOIRE FINANCIÈRE ET IMPACT PPIM
[Tableau comparatif obligatoire des montants budgétaires, suivi d'une courte analyse]

#### 🎯 3. SCÉNARIOS D'ARBITRAGE PROPOSÉS
* **Scénario 1 (Continuité) :** [Impacts, coûts et risques]
* **Scénario 2 (Phasage) :** [Alternative technique]
---
Voici les notes brutes à traiter selon les consignes ci-dessus :
